...
import { ContentState } from "src/context/content/index.types";

function ContentFooter(projectState: ContentState) {
  ...
  return (
    ...
    >
      <Box>
        <Text.SmallSecondary>Content:</Text.SmallSecondary>
      </Box>
      <Box
        sx={{
          display: "flex",
