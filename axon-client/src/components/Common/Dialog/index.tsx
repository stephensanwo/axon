...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "fixed inset-0 z-50 bg-[rgba(21,21,21,0.682)] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      className
    )}
    {...props}
  />
...
const DialogHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col justify-center p-4 space-y-1.5 sm:text-left text-primary-foreground border-b border-border h-[2.6rem]",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn("text-sm font-semibold text-primary-foreground", className)}
    {...props}
  />
));
