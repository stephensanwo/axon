...
const Terms = () => {
  return (
    <PageContainer dark>
      ...
      <p>Welcome to DevNotes!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of DevNotes's Website, located at devnotes.me.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use DevNotes if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing DevNotes, you agreed to use
        cookies in agreement with the DevNotes's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, DevNotes and/or its licensors own the
        intellectual property rights for all material on DevNotes. All
        intellectual property rights are reserved. You may access this from
        DevNotes for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from DevNotes</li>
        <li>Sell, rent or sub-license material from DevNotes</li>
        <li>Reproduce, duplicate or copy material from DevNotes</li>
        <li>Redistribute content from DevNotes</li>
      </ul>
      ...
      <p>
        ...
        DevNotes does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of DevNotes,its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, DevNotes shall not be liable
      ...
      <p>
        DevNotes reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant DevNotes a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of DevNotes; and (d) the link is
      ...
      <p>
        ...
        e-mail to DevNotes. Please include your name, your organization name,
      ...
      <p>
        No use of DevNotes's logo or other artwork will be allowed for linking
